            ...
            if ($chunkTotal) {
                ...
                if ($out) {
                    ...
                    if ($in) {
                        ...
                        $response = array(
                            'status'    => 'error',
                            'info' => "failed to open output stream",'errorDetails' => error_get_last()
                        );
                    }
                    @fclose($in);
                    @fclose($out);
        ...
        <div class="card" data-bs-theme="<?php echo FM_THEME; ?>">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <p class="custom-checkbox custom-control"><input type="checkbox" name="move" value="1" id="js-move-files" class="custom-control-input"><label for="js-move-files" class="custom-control-label ms-2"><?php echo lng('Move') ?></label>
                    </p>
                    <p>
...
?>
    ...
    <div class="col-md-8 offset-md-2 pt-3">
        <div class="card mb-2" data-bs-theme="<?php echo FM_THEME; ?>">
            <h6 class="card-headerd-flex justify-content-between">
    ...
    <div class="row">
        <div class="col-12">
            <ul class="list-group w-50 my-3" data-bs-theme="<?php echo FM_THEME; ?>">
                ...
                ?>
            </ul><div class="btn-group btn-group-sm flex-wrap" role="group">
    ...
    <head>
        ...
        <style>
            ...
            *::after {
            ...
            .message.alert {border-color: orange;
                color: orange
            }
    ...
    function fm_show_footer()
    {
        ...
        <script>
            ...
            function checkbox_toggle() {
                var e = get_checkboxes();e.push(this), change_checkboxes(e)
            }
                        ...
                        _data = {
                            "aceTheme": {
                                ...
                                "dark": {
                                    ...
                                    "gruvbox": "Gruvbox",
                                    "gob": "Green on Black",
                                    "idle_fingers": "idle Fingers","kr_theme": "krTheme",
                                    "merbivore": "Merbivore",
